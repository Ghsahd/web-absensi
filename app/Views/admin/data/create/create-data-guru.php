               ...
               <div class="card-body mx-5 my-3">
                  ...
                  <form action="<?= base_url('admin/guru/create'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nuptk" class="form-control <?= $validation->getError('nuptk') ? 'is-invalid' : ''; ?>" name="nuptk"  value="<?= old('nuptk') ?? $oldInput['nuptk'] ?? '' ?>">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="number" id="hp" name="no_hp" class="form-control <?= $validation->getError('no_hp') ? 'is-invalid' : ''; ?>" value="<?= old('no_hp') ?? $oldInput['no_hp'] ?? ''  ?>" required>
                        <div class="invalid-feedback">
