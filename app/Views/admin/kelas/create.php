          ...
          <div class="card-body mx-5 my-3">
            ...
            <form action="<?= base_url('admin/kelas'); ?>" method="post">
              ...
              <div class="form-group mt-4">
                ...
                <input type="text" id="kelas" class="form-control <?= $validation->getError('kelas') ? 'is-invalid' : ''; ?>" name="kelas" placeholder="'VII', 'VIII', 'IX'" , value="<?= old('kelas') ?? $oldInput['kelas']  ?? '' ?>" required>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <select class="custom-select <?= $validation->getError('idJurusan') ? 'is-invalid' : ''; ?>" id="idJurusan" name="idJurusan">
                    <option value="">--Pilih Rentang Kelas-</option>
